...
const reviewChannelId = process.env.REVIEW_CHANNEL_ID; // Channel ID for review/approval of applications
...
// Discord client events and interaction handling
client.once('ready', () => {
    ...
    if (interaction.isChatInputCommand()) {
        ...
        if (interaction.customId === 'applicationModal') {
            ...
            if (reviewChannel) {
                ...
                console.error(`Review channel ID ${reviewChannelId} not found.`);
                await interaction.reply({ content: 'An error occurred while processing your request.', ephemeral: true });
            }
        }
    }
