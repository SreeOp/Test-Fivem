                ...
                if (member) {
                    ...
                    if (interaction.customId === 'acceptButton') {
                        embed = new EmbedBuilder()
                            ...
                            .setColor('#00ff00')
                            .setImage('https://example.com/accepted-image.png'); // Replace with your image URL
                        roleID = '123456789012345678'; // Replace with your role ID for accepted applications
                        ...
                        embed = new EmbedBuilder()
                            ...
                            .setColor('#ffff00')
                            .setImage('https://example.com/pending-image.png'); // Replace with your image URL
                        roleID = '123456789012345678'; // Replace with your role ID for pending applications
                        ...
                        embed = new EmbedBuilder()
                            ...
                            .setColor('#ff0000')
                            .setImage('https://example.com/rejected-image.png'); // Replace with your image URL
                        roleID = '123456789012345678'; // Replace with your role ID for rejected applications
